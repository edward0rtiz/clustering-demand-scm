...
orders_layout = [
            ...
            dbc.Col(
                [
                    dbc.Row(
                        dbc.Col(
                            html.Div(
                                dcc.Graph(figure=type_plot), className="div-style"
                            ),
                        ),
                    ),
                    dbc.Row(
    ...
    dbc.Row(
        [
            dbc.Col(
                html.Div(dcc.Graph(figure=boxplot_cost), className="div-style"),
            ),
            dbc.Col(
                html.Div(dcc.Graph(figure=totalcost_byweek), className="div-style"),
            ),
        ]
    ),
    dbc.Row(
    ...
    dbc.Row(
        dbc.Col(html.Div(dcc.Graph(figure=restaurant_summary), className="div-style"))
    ),
]
...
def update_output(chart_type):
    plots = {
        "weekday": {
            ...
            "labels": {"month": "month", "order_id": "orders", "weekday": "weekday"},
        },
        "monthly": {
            "df": dforder_hourxm,
            "x": "hour",
            ...
            "labels": {"month": "month", "order_id": "orders", "hour": "hour"},
        },
        "hours": {
            "df": dforder_hourxm,
            "x": "month",
            ...
            "labels": {"month": "month", "order_id": "order", "hour": "hour"},
        },
    }
